In this project, we look at file handling in Python. We make use of the builtin functions; with, open, and read with the json module to read and write files and serialize and deserialize objects with JSON.
